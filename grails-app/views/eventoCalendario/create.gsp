<g:set var="entityName" value="${message(code: 'eventoCalendario.label', default: 'Calendarios')}" />
<g:applyLayout name="plantillaBootstrap">
    ...
    <content tag="content">
        ...
        <g:form url="[resource:eventoCalendarioInstance, action:'save']" class="form-horizontal" >
            <fieldset class="form">
